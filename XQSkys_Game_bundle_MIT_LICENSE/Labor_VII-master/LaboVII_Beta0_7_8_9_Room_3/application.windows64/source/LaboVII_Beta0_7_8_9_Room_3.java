...
public class LaboVII_Beta0_7_8_9_Room_3 extends PApplet {
...
int frame=0;
 ...
 int bnr=0;
  ...
  int spieler=1;
  int seeC=0;
  int Pirat =color(0, 0, 255);
  int Pirat2 =color(0, 255, 0);
  int Pirat3 =color(0, 255, 255);
  int Pirat4 =color(255, 0, 0);
  float movex=0;
  float movey=0;
  int edgex=0;
  int edgey=0;
...
imagest = null;
    ...
    if ((mouseoverx >= 310 && mouseoverx <= 380) && (mouseovery  >= 50 && mouseovery  <=100)) {//??
      ...
      if (mousePressed&&Admin==1) {
        ...
        {// zur erkennung ob der mausfeil über dem load button ist
...
fill(0, 200, 0);                       //malt den Load button grün über
       ...
       if (mousePressed && (mouseButton == LEFT)){   bild = loadImage(feld+"bild.png");   bnr=0;bnrb=0;       //lade in den bild speicher das bild mit dem namen bild.png aus dem haubptordner
...
if(bnr<10){
   webImg2 = loadImage(lines[0]+feld+"bild"+bnr+".png");
...
{bnr++; webImg2 = loadImage(lines[0]+feld+"bild"+bnr+".png"); if (bnr>9){
          fill(200, 0, 0);
          rect(310, 50, 70, 50 );
          fill(0);
          text("Kein", 329, 70);
     ...
     if (stepy==feld) {
      ...
      if ((mouseoverx >= x1  && mouseoverx <= x2) 
        ...
        if (mousePressed) {
          ...
          int seeCb=get(x1+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg);  
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= (x1 + 2*630/feld) && mouseoverx <= x2+2*630/feld) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg+2*630/feld, y1+kartenweg/2+kartenweg);  
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1 + 4*630/feld) && mouseoverx <= x2+4*630/feld) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg);  
      ...
      if ((mouseoverx >= x1-630/feld  && mouseoverx <= x1) 
        ...
        if (mousePressed) {
          ...
          int seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld);  
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= x1 -630/feld && mouseoverx <= x1) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*3);  
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1  -630/feld) && mouseoverx <= x1) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg-630/feld, y1+kartenweg/2+kartenweg+630/feld*5);  
      ...
      if ((mouseoverx >= x1  && mouseoverx <= x2) 
        ...
        if (mousePressed) {
          ...
          int seeCb=get(x1+kartenweg/2+kartenweg, 170+630-630/feld+kartenweg/2+kartenweg);  
      ...
      if ((x1 + 2*630/feld)<630) {
        if ((mouseoverx >= (x1 + 2*630/feld) && mouseoverx <= x2+2*630/feld) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg+2*630/feld, 170+630-630/feld+kartenweg/2+kartenweg);  
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (x1 + 4*630/feld) && mouseoverx <= x2+4*630/feld) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(x1+kartenweg/2+kartenweg+4*630/feld, 170+630-630/feld +kartenweg/2+kartenweg);  
            seeC=get(x1+kartenweg/2+kartenweg+4*630/feld, y1+kartenweg/2+kartenweg); 
            fill(seeCb);
      ...
      if ((mouseoverx >= x1+630-630/feld*2  && mouseoverx <= x1+630-630/feld*2+630/feld) 
        ...
        if (mousePressed) {
          ...
          int seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld);  
        ...
        if ((mouseoverx >= 170+630-630/feld && mouseoverx <= 170+630-630/feld+630/feld) 
          && (mouseovery  >=  y1+ 630/feld*3&& mouseovery  <=  y2+630/feld*3)) {
           if (mousePressed) {
            ...
            int seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*3);  
      ...
      if ((x1 + 4*630/feld)<630) {
        if ((mouseoverx >= (170 +630 -630/feld) && mouseoverx <= 170 +630) 
          ...
          if (mousePressed) {
            ...
            int seeCb=get(170+630-630/feld+kartenweg/2+kartenweg, y1+kartenweg/2+kartenweg+630/feld*5);  
...
int i = 0;   
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LaboVII_Beta0_7_8_9_Room_3" };
    if (passedArgs != null) {
